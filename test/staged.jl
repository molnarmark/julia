...
splat2(1)
@test String(takebuf(stagediobuf)) == "($intstr,)"
splat2(1,3)
@test String(takebuf(stagediobuf)) == "($intstr,$intstr)"
splat2(5,2)
@test String(takebuf(stagediobuf)) == ""
splat2(1:3,5.2)
@test String(takebuf(stagediobuf)) == "(UnitRange{$intstr},Float64)"
splat2(3,5:2:7)
@test String(takebuf(stagediobuf)) == "($intstr,StepRange{$intstr,$intstr})"
splat2(1,2,3,4)
@test String(takebuf(stagediobuf)) == "($intstr,$intstr,$intstr,$intstr)"
splat2(1,2,3)
@test String(takebuf(stagediobuf)) == "($intstr,$intstr,$intstr)"
splat2(1:5, 3, 3:3)
@test String(takebuf(stagediobuf)) == "(UnitRange{$intstr},$intstr,UnitRange{$intstr})"
splat2(1:5, 3, 3:3)
@test String(takebuf(stagediobuf)) == ""
splat2(1:5, 3:3, 3)
@test String(takebuf(stagediobuf)) == "(UnitRange{$intstr},UnitRange{$intstr},$intstr)"
splat2(1:5, 3:3)
@test String(takebuf(stagediobuf)) == "(UnitRange{$intstr},UnitRange{$intstr})"
splat2(3, 3:5)
@test String(takebuf(stagediobuf)) == "($intstr,UnitRange{$intstr})"
